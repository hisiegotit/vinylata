...
--
-- Host: 127.0.0.1    Database: vinylata
-- ------------------------------------------------------
...
CREATE TABLE `category` (
  ...
  `category_background` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `orders` (
  ...
  `order_user_email` varchar(255) DEFAULT NULL,
  `order_user_name` varchar(255) DEFAULT NULL,
  `order_user_phone` varchar(255) DEFAULT NULL,
...
CREATE TABLE `product` (
  ...
  `product_detail` varchar(512) NOT NULL,
  `product_image` varchar(255) NOT NULL,
  `product_pricing` double NOT NULL,
...
CREATE TABLE `vendor` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `vendor_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `vendor_image` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_5uqc0qxa4fn0ukhcr8h49y16p` (`vendor_name`)
...
CREATE TABLE `voucher` (
  ...
  `expirated_date` datetime(6) DEFAULT NULL,
  `name` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2023-05-19 20:47:06
